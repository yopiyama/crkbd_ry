...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT( \
    ...
    KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_EQL,\
                            KC_LGUI, LALT_T(KC_ESC),  LT(_SYM, KC_SPC),   LT(_NUM, KC_ENT),  LSFT_T(KC_BSPC), KC_ESC \
  ),
  ...
  [_NUM] = LAYOUT( \
    _______,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                       KC_PPLS, KC_PMNS, KC_PAST, KC_PSLS, KC_PEQL,  KC_ENT,\
    _______,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                       KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, XXXXXXX, XXXXXXX,\
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       KC_DEL,  XXXXXXX, KC_COMM,  KC_DOT, XXXXXXX, XXXXXXX,\
...
// Setting LEDS layer RGB back to default
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
    ...
    case NUM:
      if (record->event.pressed) {
        layer_on(_NUM);
        update_tri_layer_RGB(_NUM, _SYM, _LEDS);
      } else {
        layer_off(_NUM);
        update_tri_layer_RGB(_NUM, _SYM, _LEDS);
      }
